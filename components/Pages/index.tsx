  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", }}>
      ...
      {state.form == "bookspecs" ? <WindowFloat
        ...
        <g-b style={{backgroundColor:state.cart.includes(state.book.title)?"#C73B3B" : "#4C26F5"
        ...
        onClick={()=>{
          ...
          {/* <img src="https://cdn.ituring.ir/research/70/hrt.webp"
      ...
      <Window title='سبد خرید' style={{ margin: 10, width: "calc(100% - 20px)", fontFamily:" vrb"}}>
      ...
      <Window title={name}
        style={{ minHeight: 200, margin: 10, width: "calc(100% - 20px)", fontFamily:" vrb"}}>
